...
## Project Structure
    ...
    ├── testapiautosetting_127282  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127282`
...
2. Clone this repo and `cd testapiautosetting_127282`
